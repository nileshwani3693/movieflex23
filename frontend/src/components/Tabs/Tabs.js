                  ...
                  <div className="container">
                      <div id="tab-1-content" className={`tab-content-item ${activeTabName === CANCEL_AT_ANY_TIME && "show"}`}>
                          <div className="tab-1-content-inner">
                              <div>
                                  <p className="text-lg">
                                      If you decide MovieFlix isn't for you - no problem. No
                                      commitment. Cancel online anytime

                                  </p>
                                  <Link to="/movieflix-show" className="btn btn-lg">
              ...
              <section className="tab-content">
                  ...
                  <div id="tab-3-content" className={`tab-content-item ${activeTabName === PICK_YOUR_PRICE && "show"}`}> 
                       ...
                       <table className="table">
                           ...
                           <tbody>
                               <tr>
                                   <td> Monthly price after free month ends on 6/12/2021</td>
                                   <td>$6.99</td>
                                   <td>$11.99</td>
                                   <td>$15.99</td>
                               </tr>
